...
class PhpBuf_MessageTest extends PHPUnit_Framework_TestCase {
    ...
    public function testMessageWriter_GoogleTest1() {
    	$message = new Message_Example_Test1();
    	$message->a = 150;
    	$writer = new IO_Writer();
    	$message->write($writer);
    ...
    public function testMessageWriter_GoogleTest2() {
    	$message = new Message_Example_Test2();
    	$message->b = "testing";
    	$writer = new IO_Writer();
    	$message->write($writer);
    ...
    public function testNestedMessages() {
		...
		$this->assertType("Message_Example_Test1", $message->c);
	...
	public function testSetWrongTypes() {
		$this->setExpectedException('Field_Exception');
        $message = new Message_Example();
